 ...
 * @author Arturo
 */
public class opcionCamiones extends javax.swing.JPanel {

    /**
     * Creates new form opcionAutomoviles
     */
    public opcionCamiones() {
        initComponents();
    ...
    private void iniciarParqueadero1() {
        ...
        while (Datos.getPilaCamionesPrincipal().pilaVacia() != true) {

            listModel.addElement(Datos.getPilaCamionesPrincipal().obtenerElementoPila().getFabricante());

            Datos.getColaCamionesPrincipal().agregarALaCola(Datos.getPilaCamionesPrincipal().obtenerElementoPila());

            Datos.getPilaCamionesPrincipal().desapilar();
    ...
    private void iniciarTaller() {
        ...
        while (Datos.getColaCamionesPrincipal().colaVacia() == false) {

            listModel.addElement(Datos.getColaCamionesPrincipal().obtenerPrimeroDeLaCola().getFabricante());
            Datos.getPilaCamionesPrincipal().apilar(Datos.getColaCamionesPrincipal().obtenerPrimeroDeLaCola());

            Datos.getColaCamionesPrincipal().eliminarDeLaCola();
